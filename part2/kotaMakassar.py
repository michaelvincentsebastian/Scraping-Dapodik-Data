...
def process_school(sekolah, processed_ids, province_name, city_name, kecamatan_name):
    ...
    # Pengecekan ID yang sudah diproses tetap di sini untuk menghindari request yang tidak perlu
    ...
    try:
        ...
        # Jeda PENTING untuk menghindari Rate Limiting dari server Dapodik
        time.sleep(SCHOOL_DETAIL_DELAY) 
...
def main():
    ...
    for province in provinsi_list:
        ...
        if nama_prov_upper != TARGET_PROVINCE_NAME:
            continue # Langsung skip provinsi lain
            ...
            for kecamatan in response_kecamatan:
                ...
                with concurrent.futures.ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
                    ...
                    for future in concurrent.futures.as_completed(futures):
                        ...
                        if result_id and result_id is not True: # Cek jika bukan True (yang berarti skip)
